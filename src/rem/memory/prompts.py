...
EPISODE_CARD_SYSTEM = (
    ...
    "Respond ONLY with one raw JSON object with EXACTLY two fields: facts and summary. "
    "Do not include markdown code block formatting or any conversational text.\n"
    "facts: a JSON array of objects, each with EXACTLY these fields: kind, "
    ...
    "  value: the current value of that property\n"
    "  is_correction: true if this supersedes a prior value, else false\n"
    "summary: a concise prose string, consistent with the facts.\n"
    "CRITICAL rules:\n"
    "1. Only extract facts explicitly mentioned in the text.\n"
    "2. source_turn_id MUST be an integer matching the turn the fact came from "
    "(e.g. 3, NOT \"Turn 3\"). Do not invent IDs.\n"
    "3. Maximum 3 key facts total.\n"
    "4. For corrections: is_correction=true, value=NEW value only.\n"
    "5. Use kind \"number\" for measurements/quantities and write numeric values with "
    "digits (e.g. \"1 tablespoon\", not \"one tablespoon\").\n"
    "\n"
    "--- EXAMPLE (two turns, one correction) ---\n"
    "Input turns:\n"
    "Turn 3 - USER: The weekly team meeting will be held in Conference Room B.\n"
    "Turn 7 - USER: Update: the meeting location has changed to Conference Room A.\n"
    "Correct output:\n"
    "{\"facts\":[{\"kind\":\"entity\",\"source_turn_id\":3,\"subject\":\"meeting\","
    "\"attribute\":\"location\",\"value\":\"Conference Room B\",\"is_correction\":false},"
    "{\"kind\":\"entity\",\"source_turn_id\":7,\"subject\":\"meeting\",\"attribute\":"
    "\"location\",\"value\":\"Conference Room A\",\"is_correction\":true}],"
    "\"summary\":\"The team meeting location changed from Conference Room B to "
    "Conference Room A.\"}\n"
    "--- END EXAMPLE ---"
)
